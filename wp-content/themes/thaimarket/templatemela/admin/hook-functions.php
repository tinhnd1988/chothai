...
if ( ! function_exists( 'templatemela_id1' ) ) {
 function templatemela_id1($atts){  
       ...
       echo esc_attr( stripslashes(get_option('templatemela_header_before')) ); 
...
if ( ! function_exists( 'templatemela_id12' ) ) {
	function templatemela_id12() {
		echo esc_attr( stripslashes(get_option('templatemela_header')) );
	}
}
...
if ( ! function_exists( 'templatemela_id2' ) ) {
	function templatemela_id2() {
		echo esc_attr( stripslashes(get_option('templatemela_header_inside')) );
	}
}
...
if ( ! function_exists( 'templatemela_id3' ) ) {
	function templatemela_id3() {
		echo esc_attr( stripslashes(get_option('templatemela_header_after')) );
	}
}
...
if ( ! function_exists( 'templatemela_id4' ) ) {
	function templatemela_id4() {
		echo esc_attr( stripslashes(get_option('templatemela_footer_before')) );
	}
}
...
if ( ! function_exists( 'templatemela_id5' ) ) {
	function templatemela_id5() {
		echo esc_attr( stripslashes(get_option('templatemela_footer_inside')) );
	}
}
...
if ( ! function_exists( 'templatemela_id6' ) ) {
	function templatemela_id6() {
		echo esc_attr( stripslashes(get_option('templatemela_footer_after')) );
	}
}
...
if ( ! function_exists( 'templatemela_id7' ) ) {
	function templatemela_id7() {
		echo esc_attr( stripslashes(get_option('templatemela_content_before')) );
	}
}
...
if ( ! function_exists( 'templatemela_id8' ) ) {
	function templatemela_id8() {
		echo esc_attr( stripslashes(get_option('templatemela_content_after')) );
	}
}
...
if ( ! function_exists( 'templatemela_id9' ) ) {
	function templatemela_id9() {
		echo esc_attr( stripslashes(get_option('templatemela_main_before')) );
	}
}
...
if ( ! function_exists( 'templatemela_id10' ) ) {
	function templatemela_id10() {
		echo esc_attr( stripslashes(get_option('templatemela_left_before')) );
	}
}
...
if ( ! function_exists( 'templatemela_id11' ) ) {
	function templatemela_id11() {
		echo esc_attr( stripslashes(get_option('templatemela_left_after')) );
	}
}
...
if ( ! function_exists( 'templatemela_id12' ) ) {
	function templatemela_id12() {
		echo esc_attr( stripslashes(get_option('templatemela_right_before')) );
	}
}
...
if ( ! function_exists( 'templatemela_id13' ) ) {
	function templatemela_id13() {
		echo esc_attr( stripslashes(get_option('templatemela_right_after')) );
	}
}
...
if ( ! function_exists( 'templatemela_id14' ) ) {
  function templatemela_id14() {  
    echo esc_attr( stripslashes(get_option('templatemela_custom_css')) );
  }
}