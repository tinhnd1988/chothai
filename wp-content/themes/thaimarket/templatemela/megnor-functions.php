...
function tm_set_default_options()
{
	...
	add_option("tmoption_logo_image_alt",'FrreshMarket'); // set logo image alt
	...
	add_option("tmoption_background_upload",get_template_directory_uri()."/images/megnor/body-bg.png"); // Default, texture specified image
	...
	add_option("tmoption_button_color","8AC42F"); // button color
	add_option("tmoption_button_hover_color","6CCBE2"); // button hover color
	...
	add_option("tmoption_header_bkg_color","8AC42F"); // Navigation background color
	add_option("tmoption_header_bkg_hover_color","64A500"); // Navigation Hover background color	
	
		
	/*  Content Settings  */
	add_option("tmoption_h1font",'Rokkitt'); // h1 family google font
	add_option("tmoption_h1font_other",'Arial'); // h1 family specified font
	add_option("tmoption_h1color",'75AD17'); // h1 family font color	 
	add_option("tmoption_h2font",'Rokkitt'); // h2 family google font
	add_option("tmoption_h2font_other",'Arial'); // h2 family specified font
	add_option("tmoption_h2color",'75AD17'); // h2 family font color	
	add_option("tmoption_h3font",'Rokkitt'); // h3 family google font
	add_option("tmoption_h3font_other",'Arial'); // h3 family specified font
	add_option("tmoption_h3color",'75AD17'); // h3 family font color	
	add_option("tmoption_h4font",'Rokkitt'); // h4 family google font
	add_option("tmoption_h4font_other",'Arial'); // h4 family specified font
	add_option("tmoption_h4color",'75AD17'); // h4 family font color	
	add_option("tmoption_h5font",'Rokkitt'); // h5 family google font
	add_option("tmoption_h5font_other",'Arial'); // h5 family specified font 
	add_option("tmoption_h5color",'75AD17'); // h5 family font color	
	add_option("tmoption_h6font",'Rokkitt'); // h6 family google font
	add_option("tmoption_h6font_other",'Arial'); // h6 family specified font 
	add_option("tmoption_h6color",'75AD17'); // h6 family font color	
	add_option("tmoption_link_color","777777"); // link color
	add_option("tmoption_hoverlink_color","75AD17"); // link hovre color
	...
	add_option("tmoption_footerhoverlink_color","8AC42F"); // footer link hover text color
...
function templatemela_load_styles() {
	...
	wp_enqueue_style('custom-1', get_template_directory_uri() . '/css/megnor/lightbox.css');
...
function templatemela_load_scripts() {	
	...
	wp_enqueue_script( 'jstree_min_', get_template_directory_uri() . '/js/megnor/lightbox-2.6.min.js', array(), '', true);	
...
add_image_size( 'blog-posts-list', 630, 270, true );
...
function woocommerce_output_related_products() {
	$no = get_option("tmoption_related_items_per_row");
