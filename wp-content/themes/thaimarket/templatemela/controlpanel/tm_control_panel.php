...
<style type="text/css">
	...
	.main-navigation li a:hover{ background-color:#<?php echo esc_attr( get_option('tmoption_header_bkg_hover_color') ) ; ?>; } 
	...
	<?php /*?>.mega-menu li span, .menu-toggle-image{
	background: url("<?php echo esc_url( get_option('tmoption_navigation_background_upload') ); ?>") no-repeat scroll center center #<?php echo esc_attr( get_option('tmoption_header_menu_color1') ); ?> ;}	<?php */?>
